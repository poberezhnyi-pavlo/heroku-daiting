    ...
    <div class="row">
        <div class="col-12">
            <div class="card card-info">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form class="form-horizontal" method="POST" action="{{route('gifts.update', $gift->id)}}" enctype="multipart/form-data">
                    @method('PUT')
                    @csrf
                    <div class="card-body">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input
                                                        ...
                                                        value="{{$gift->translate($localeCode)->title}}"
                                                    >
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    ...
                                                    >{{$gift->translate($localeCode)->description}}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    @endforeach
